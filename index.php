...
./<a href="../">Top</a>/タイトル取得2
<form method="POST" action="./index.php">
<input type="hidden" name="act" value="inp">
<table border="0" cellpadding="1">
<tr>
<td bgcolor="#dddddd">URL LIST</td>
<td><textarea rows="5" name="urllist" cols="60"><?PHP echo($_POST["urllist"]); ?></textarea></td>
</tr>
<tr>
<td></td>
<td align="center"><input type="button" onClick="clearFormAll()" value="フォームクリア">&nbsp;&nbsp;<input type="submit" value="タイトル取得2" name="B1"></td>
</tr>
</table>
</form>
